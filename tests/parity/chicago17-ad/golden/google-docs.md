...
The foundational treatment of pragmatic markers in contact situations came from Smith (2010), whose framework has shaped subsequent work. Recent quantitative evidence reinforced the general claim (Smith 2010, 22). Classroom-discourse data produced complementary findings in Jones and Cruz (2015), while the urban multilingual synthesis (Able, Baker, and Chen 2019) broadened the empirical base.
