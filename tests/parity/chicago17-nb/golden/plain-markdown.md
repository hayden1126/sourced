...
The argument developed by Jane A. Smith[^1] ran counter to earlier claims about
pragmatic markers in contact situations. Smith's later treatment[^2]
extended the point with closer reading of the data. The parallel case in
classroom discourse received fresh attention from Robert Jones and Elena Cruz[^3], who showed
similar dynamics at scale.[^4] Broader empirical work
covered urban multilingual contexts as well.[^5]
